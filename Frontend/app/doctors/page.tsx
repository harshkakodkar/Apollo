...
export default function AddDoctorPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6">
        <Link href="/doctors" className="flex items-center text-teal-600 hover:text-teal-700">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleCheckboxChange("consultModes", "online", checked as boolean)}
                  />
                  <label
                    htmlFor="mode-online"
                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="mode-hospital"
                    checked={formData.consultModes.includes("hospital")}
                    onCheckedChange={(checked) => handleCheckboxChange("consultModes", "hospital", checked as boolean)}
                  />
                  <label
                    htmlFor="mode-hospital"
                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                  >
                    Hospital Visit
                  </label>
